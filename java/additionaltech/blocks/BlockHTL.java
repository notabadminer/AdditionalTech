...
public class BlockHTL extends BlockContainer{
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		blockIcon = par1IconRegister.registerIcon("additionaltech:DarkCasing");
		blockIconFaceActive = par1IconRegister.registerIcon("additionaltech:HTLFaceActive");
		blockIconFace = par1IconRegister.registerIcon("additionaltech:HTLFace");
	}
