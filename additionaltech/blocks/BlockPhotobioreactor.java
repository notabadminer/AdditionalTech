...
public class BlockPhotobioreactor extends BlockContainer {
	
	public BlockPhotobioreactor() {
	...
	protected IIcon ioIcon;

	@Override
	@SideOnly(Side.CLIENT)
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		blockIcon = par1IconRegister.registerIcon("additionaltech:photobioreactor");
		ioIcon = par1IconRegister.registerIcon("additionaltech:photobioreactor-io");
	}
