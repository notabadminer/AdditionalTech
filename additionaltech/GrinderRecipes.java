...
public class GrinderRecipes {
	...
	private static void grinderRecipes() {
		...
		addGrinding(Items.diamond,new ItemStack(RegistryHandler.dustDiamond, 3), 1.0F);
		addGrinding(Item.getItemFromBlock(Blocks.obsidian), new ItemStack(RegistryHandler.dustObsidian, 3), 1.0F);
