...
public class ContainerGrinder extends Container {
		...
		public ContainerGrinder(InventoryPlayer inventoryPlayer, TileGrinder tEntity) {
			...
			addSlotToContainer(new SlotGrinderUpgrade(tileEntity, TileGrinder.slotUpgrade1, 152, 42));
			addSlotToContainer(new SlotGrinderUpgrade(tileEntity, TileGrinder.slotUpgrade2, 152, 60));
			addSlotToContainer(new SlotGrinderUpgrade(tileEntity, TileGrinder.slotUpgrade3, 152, 78));
