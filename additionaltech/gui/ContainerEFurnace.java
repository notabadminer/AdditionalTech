...
public class ContainerEFurnace extends Container {
		...
		public ContainerEFurnace(InventoryPlayer inventoryPlayer, TileEFurnace tEntity) {
			...
			addSlotToContainer(new SlotOutput(tileEntity, TileEFurnace.slotOutput, 109, 58));
			addSlotToContainer(new SlotBattery(tileEntity, TileEFurnace.slotBattery, 29, 82));
			addSlotToContainer(new SlotFurnaceUpgrade(tileEntity, TileEFurnace.slotUpgrade1, 152, 42));
			addSlotToContainer(new SlotFurnaceUpgrade(tileEntity, TileEFurnace.slotUpgrade2, 152, 60));
			addSlotToContainer(new SlotFurnaceUpgrade(tileEntity, TileEFurnace.slotUpgrade3, 152, 78));
